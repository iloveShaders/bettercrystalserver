...
enum ClientEvent_t : uint8_t {
	...
	CLIENT_EVENT_DEATHPVE = 2, // deprecated, triggers by death message now
	CLIENT_EVENT_DEATHPVP = 3, // deprecated, triggers by death message now
	...
	CLIENT_EVENT_TUTORIALCOMPLETE = 14, // new tutorial finish popup "off to new shores"
};
